"""
Adapted from:
https://github.com/CompVis/stable-diffusion/blob/69ae4b35e0a0f6ee1af8bb9a5d0016ccb27e36dc/ldm/modules/losses/contperceptual.py
"""
...
class LPIPSWithDiscriminator(nn.Module):
    ...
    def forward(self, inputs, reconstructions, posteriors, optimizer_idx,
        ...
        if self.perceptual_weight > 0:
            p_loss = self.perceptual_loss(inputs, reconstructions).float()
